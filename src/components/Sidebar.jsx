    ...
    <>
      <div class="flex flex-col h-full p-3 w-64 dark:bg-white dark:text-gray-900">
        <div class="space-y-3">
          ...
          <div className="bg-[#ECEFF1] p-2">
            <p className="text-[#A8B4B5] text-[10px]">My Project</p>
            <h6 className="text-[12px] font-semibold">My First Project</h6>
          </div>
          <div class="flex-1">
            <ul class="pt-2 pb-4 space-y-1 text-[10px]">
              <div className="text-[#607D8A] font-medium">
                <li class="rounded-sm">
        ...
        <div class="bg-[#ECF9FF] flex items-center p-2 mt-12 space-x-4 justify-self-end text-[10px] w-48">
          <div class="flex-1">
            <div class="flex items-center space-x-4 p-2 mb-5">
              ...
              <div>
                ...
                <span class=" tracking-wide flex items-center space-x-1">
                  <span class="text-gray-600 text-[8px]">
                    Credits Used: 313
                  </span>
                </span>
              </div>
            ...
            <ul class="pt-2 pb-4 space-y-1 text-[8px]">
              <li className="flex p-2 bg-green-500 rounded-lg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                ...
                <span className="px-2 text-white text-[10px]">
                  Change Plans
                </span>
              </li>
              <li class="rounded-sm">
        ...
        <div className="rounded-sm">
          <div class="flex items-center py-2 px-4 space-x-3 rounded-md">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              class="w-5 h-5 fill-current dark:text-gray-400"
